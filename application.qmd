...
`PostgreSQL 11` → `SQL Shell (psql)`을 클릭한 후에 postgreSQL 헬로월드를
...
예시](images/postgreSQL-dvd-select.png){width="100%"}
...
![DVD ER
다이어그램](images/dvd-rental-sample-database-diagram.png){width="100%"}
...
![테이블 구조 시각화 -
구매금액](images/dvd-rental-amount.png){width="100%"}
